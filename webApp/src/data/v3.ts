...
export const services = [
  {
    ...
    text: "Быстрый сайт, который понятно рассказывает об услуге и готов к продвижению в поиске.",
  },
  {
  ...
  },
  {
    ...
    text: "Интерфейс, в котором сложная бизнес-логика остаётся понятной пользователю и команде разработки.",
  },
  {
    title: "Калькуляторы",
    text: "Превращаю формулу или сложный выбор в понятный инструмент, который приводит целевой поисковый трафик.",
  },
  {
    title: "Telegram Mini Apps",
    text: "Запускаю сервис там, где уже находится аудитория: без отдельной установки и лишнего входа.",
  },
  {
    title: "Доработка сайтов",
    text: "Нахожу причину проблемы, исправляю её без каскада новых ошибок и оставляю понятный результат.",
  },
  {
    title: "SEO-аудит",
    text: "Показываю, что мешает сайту индексироваться, ранжироваться и превращать поисковый спрос в обращения.",
  },
];
